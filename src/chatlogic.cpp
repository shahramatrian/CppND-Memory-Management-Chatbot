...
ChatLogic::~ChatLogic()
{
    ...
    // Since each node is a smart pointer they are deleted automatically 

    // Since each edge is a smart pointer they are deleted automatically 
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            _nodes.emplace_back(std::make_unique<GraphNode>(id)); //TODO: check it
